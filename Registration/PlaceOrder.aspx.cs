...
namespace Registration
{
    public partial class PlaceOrder : System.Web.UI.Page
    {
        ...
        {
            SqlConnection con = new SqlConnection("Data Source = LENOVO\\SQLEXPRESS; Initial Catalog = RecordDB; Integrated Security = True");
            con.Open();
            SqlCommand cmd = new SqlCommand("insert into CartDetails" + "(Fname,Lname,CardNo,ExpiryDate,CVV,BillingAddr) values (@Fname,@Lname,@CardNo,@ExpiryDate,@CVV,@BillingAddr)", con);
