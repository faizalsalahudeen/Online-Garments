...
namespace Registration
{
    ...
    {
        SqlConnection con = new SqlConnection("Data Source=.\\SQLEXPRESS;Initial Catalog=ShoppingDB;Integrated Security=True");
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["id"] != null)
                {
                    if (Session["Buyitems"] == null)
                    {
                        ...
                        dr = dt.NewRow();
                        SqlConnection conn = new SqlConnection("Data Source = LENOVO\\SQLEXPRESS; Initial Catalog = RecordDB; Integrated Security = True");
                    ...
                    else
                    {
                        ...
                        dr = dt.NewRow();
                        SqlConnection scon = new SqlConnection("Data Source = LENOVO\\SQLEXPRESS; Initial Catalog = RecordDB; Integrated Security = True");
